...
<body>
    ...
    <body>
        Select: <select name="cls" id="cls" required>
            <option value="" selected disabled>Select Option</option>
            <?php
            $tid = '1010';
            $query = "SELECT a.stream, b.course, c.from, c.to, c.batch FROM tbl1_stream a JOIN tbl1_course b JOIN tbl_class c ON
                    a.str_id = c.stream_name AND b.c_id = c.course AND c.class_teacher = '$tid'";
            ?>
        </select>
